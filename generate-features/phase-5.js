...
const generateScenariosFunction = () => {
  const allScenarioObject = {
    TC5_01: {
      type: 'Scenario',
      description: 'Check TH URL có params chứa key/value KHÔNG MATCH với key/value trong CMS, SFID không hợp lệ, Cookies đã có SFID',
      dynamic: {
  ...
  generateScenario('TC5_02', allScenarioObject, {
    required: 'TC5_01',
  ...
  generateScenario('TC5_03', allScenarioObject, {
    required: 'TC5_01',
  ...
  generateScenario('TC5_04', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_05', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_06', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_07', allScenarioObject, {
    required: 'TC5_02',
    description: 'Ở vào tab Location Không hiện box Instant Video:(không có data) #NEGATIVE',
    dynamic: {
      _fakeData: 'emptyDropdown'
    },
    steps: [
  ...
  generateScenario('TC5_08', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_09', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_10', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_11', allScenarioObject, {
    required: 'TC5_02',
  ...
  generateScenario('TC5_12', allScenarioObject, {
    required: 'TC5_04',
  ...
  generateScenario('TC5_13', allScenarioObject, {
    required: 'TC5_04',
  ...
  generateScenario('TC5_14', allScenarioObject, {
    required: 'TC5_13',
  ...
  generateScenario('TC5_15', allScenarioObject, {
    required: 'TC5_04',
  ...
  generateScenario('TC5_16', allScenarioObject, {
    required: 'TC5_04',
  ...
  generateScenario('TC5_17_01', allScenarioObject, {
    required: 'TC5_12',
  ...
  generateScenario('TC5_17_02', allScenarioObject, {
    required: 'TC5_13',
    description: 'Chọn một Video Consult -> Tìm thấy các slot trong vòng 15 ngày',
    dynamic: {
      _fakeData: 'fullDropdownHaveLoadMore'
  ...
  generateScenario('TC5_18_01', allScenarioObject, {
    required: 'TC5_12',
  ...
  generateScenario('TC5_18_02', allScenarioObject, {
    required: 'TC5_13',
  ...
  generateScenario('TC5_19', allScenarioObject, {
    required: 'TC5_12',
  ...
  generateScenario('TC5_20', allScenarioObject, {
    required: 'TC5_19',
  ...
  generateScenario('TC5_21', allScenarioObject, {
    required: 'TC5_14',
  ...
  generateScenario('TC5_22', allScenarioObject, {
    required: 'TC5_21',
  ...
  generateScenario('TC5_23_01', allScenarioObject, {
    required: 'TC5_19',
  ...
  generateScenario('TC5_23_02', allScenarioObject, {
    required: 'TC5_21',
  ...
  generateScenario('TC5_24_01', allScenarioObject, {
    required: 'TC5_19',
  ...
  generateScenario('TC5_24_02', allScenarioObject, {
    required: 'TC5_21',
  ...
  generateScenario('TC5_25_01', allScenarioObject, {
    required: 'TC5_06',
  ...
  generateScenario('TC5_25_02', allScenarioObject, {
    required: 'TC5_11',
    description: 'Chọn Instant Video button > book thành công',
    dynamic: {
      _fakeData: 'fullDropdownHaveConfirm'
  ...
  generateScenario('TC5_26_01', allScenarioObject, {
    required: 'TC5_06',
  ...
  generateScenario('TC5_26_02', allScenarioObject, {
    required: 'TC5_11',
    description: 'Chọn Instant Video button > book không thành công',
    dynamic: {
      _fakeData: 'fullDropdownHaveConfirm'
...
module.exports = {
  name: 'Scheduler with params',
  filePath: 'cypress/integration/schedule/5.invalidBannerParam-invalidSFID-validCookies.feature',
  options: {
    description: 'Check TH URL có params chứa key/value KHÔNG MATCH với key/value trong CMS, SFID không hợp lệ, Cookies đã có SFID.',
    backgroundName: 'Scheduler Page with params',
    backgroundSteps: [
