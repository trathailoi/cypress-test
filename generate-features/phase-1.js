...
const generateScenariosFunction = () => {
  const allScenarioObject = {
    TC_01: {
      type: 'Scenario',
      description: 'URL không có params, cookie chưa có SFID #POSITIVE',
      steps: [
  ...
  generateScenario('TC_02', allScenarioObject, {
    required: 'TC_01',
  ...
  generateScenario('TC_03', allScenarioObject, {
    required: 'TC_01',
  ...
  generateScenario('TC_04', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_05', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_06', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_07', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_08', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_09', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_10', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_11', allScenarioObject, {
    required: 'TC_02',
  ...
  generateScenario('TC_13', allScenarioObject, {
    required: 'TC_04',
  ...
  generateScenario('TC_16', allScenarioObject, {
    required: 'TC_04',
  ...
  generateScenario('TC_17_02', allScenarioObject, {
    required: 'TC_13',
    description: 'Chọn một Video Consult -> Tìm thấy các slot trong vòng 15 ngày',
    dynamic: {
      _fakeData: 'fullDropdownHaveLoadMore'
  ...
  generateScenario('TC_18_02', allScenarioObject, {
    required: 'TC_13',
...
module.exports = {
  name: 'Scheduler',
  filePath: 'cypress/integration/schedule/1.default-scheduler.feature',
  options: {
